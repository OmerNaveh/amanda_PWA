...
export default function GradientButton({
  ...
  return (
    <motion.button
      ...
      whileTap={{ scale: 0.96 }}
      className={cn(
        "inline-flex items-center justify-center rounded-lg border border-white/30 bg-white/10 px-5 py-3 font-medium text-white backdrop-blur-sm hover:bg-white/20 transition-all duration-300",
        className
      )}
      {...props}
    >
